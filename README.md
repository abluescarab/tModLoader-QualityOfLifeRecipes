...
| ![](readme/HeavyWorkBench.png) Heavy Work Bench | <ul><li>![](readme/GoldBar.png) ![](readme/PlatinumBar.png) Any Gold Bar (x8)</li><li>![](readme/IronBar.png) ![](readme/LeadBar.png) Any Lead Bar (x15)</li><li>![](readme/Cloud.png) Cloud (x15)</li><li>![](readme/SnowBlock.png) Snow Block (x15)</li></ul> | | ![](readme/WeatherRadio.png) Weather Radio |
