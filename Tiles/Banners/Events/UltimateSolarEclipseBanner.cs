...
namespace QualityOfLifeRecipes.Tiles.Banners.Events {
    public class UltimateSolarEclipseBanner : ModTile {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            Item.NewItem(i * 16, j * 16, 16, 48, mod.ItemType("UltimateSolarEclipseBanner"));
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer) {
            if(closer) {
                ...
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.Mothron)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.MothronEgg)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.MothronSpawn)] = true;
