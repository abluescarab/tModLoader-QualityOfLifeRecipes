...
namespace QualityOfLifeRecipes.Tiles.Banners.Events {
    public class PirateCrewBanner : ModTile {
        public override void SetStaticDefaults() {
            ...
            translation.SetDefault("{$Mods.QualityOfLifeRecipes.Placeable.Banners.Events.PirateCrewBanner}");
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeable.Banners.Events.PirateCrewBanner>());
        }
