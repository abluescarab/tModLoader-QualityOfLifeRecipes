...
namespace QualityOfLifeRecipes.Tiles.Banners.Dungeon {
    public class UltimateDungeonBanner : ModTile {
        public override void SetStaticDefaults() {
            ...
            translation.SetDefault("{$Mods.QualityOfLifeRecipes.Placeable.Banners.Dungeon.UltimateDungeonBanner}");
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeable.Banners.Dungeon.UltimateDungeonBanner>());
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer) {
            if(closer) {
                ...
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.Paladin)] = true;
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.SkeletonCommando)] = true;
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.SkeletonSniper)] = true;
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.TacticalSkeleton)] = true;
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.BoneLee)] = true;
                Main.SceneMetrics.NPCBannerBuff[Item.NPCtoBanner(NPCID.DungeonSpirit)] = true;
