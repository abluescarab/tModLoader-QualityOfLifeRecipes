...
namespace QualityOfLifeRecipes.Tiles.Banners.Dungeon {
    public class UltimateDungeonBanner : ModTile {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            Item.NewItem(i * 16, j * 16, 16, 48, mod.ItemType("UltimateDungeonBanner"));
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer) {
            if(closer) {
                ...
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.Paladin)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.SkeletonCommando)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.SkeletonSniper)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.TacticalSkeleton)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.BoneLee)] = true;
                player.NPCBannerBuff[Item.NPCtoBanner(NPCID.DungeonSpirit)] = true;
